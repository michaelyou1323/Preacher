...
public class FourthProgrammeFragment extends Fragment {
    RecyclerView recyclerView;
    MyAdapter myAdapter;
    ArrayList<User> users;


    public FourthProgrammeFragment() {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_fourth_programme, container, false);


        recyclerView = view.findViewById(R.id.userList4);
